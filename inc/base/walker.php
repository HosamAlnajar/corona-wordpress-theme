 ...
 */
class Corona_Walker_Nav_Primary extends Walker_Nav_Menu {
	/*
		// li a span
		...
		function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			error_log( print_r( $item_output, true ) );
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( isset( $args->has_children ) && $args->has_children  && $args->depth > 1 ) {
			...
			$atts['class']         = 'dropdown-toggle nav-link custom-blue';
			...
			if ( $depth > 0 ) {
				...
				$atts['class'] = 'nav-link custom-red';
			}
		}
