...
function Nav() {
	...
	return (
		<nav className="react-nav-menu">
			<div className="container mx-auto px-4 d-flex flex-row align-items-center justify-content-between px-4 py-6">

				<ul className="nav-links">
					<Link to='/'>
						<svg className="w-75" viewBox="0 0 96 24" fill="none">
							<path
					...
					<Link to='/about'>
						<li className="react-nav-link">About</li>
					</Link>
					<Link to='/posts'>
						<li className="react-nav-link">Posts</li>
					</Link>
				</ul>
				...
				<div className="d-flex flex-row align-items-center">
					...
					<div className="ml-4 mt-0 ">
						<a href="#">
							<img src="http://localhost:8888/create_theme/wp-content/uploads/2020/04/emoji.png" alt="avatar" className="avatar-login"/>
						</a>
					</div>
				</div>
			</div>
