...
function corona_scripts() {
	...
	wp_enqueue_script( 'corona-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
/**
 * API: Add featured image directly to REST API.
 */
...
/**
 * API:  Get post with tag names instead of tag ID's.
 */
